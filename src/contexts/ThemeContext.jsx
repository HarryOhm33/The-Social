...
const lightTheme = {
  ...
  buttonPrimaryHover: "hover:from-purple-700 hover:to-pink-700",
  buttonSecondary: "border-2 border-purple-600 text-purple-600",
  buttonSecondaryHover: "hover:bg-purple-50",
...
const darkTheme = {
  ...
  buttonPrimary: "bg-gradient-to-r from-purple-600 to-pink-600 text-white",
  buttonPrimaryHover: "hover:from-purple-700 hover:to-pink-700",
  buttonSecondary: "border-2 border-purple-400 text-purple-400",
  buttonSecondaryHover: "hover:bg-purple-900/20",
